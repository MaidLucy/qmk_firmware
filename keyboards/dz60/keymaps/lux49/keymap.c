...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [1] = LAYOUT_60_iso_5x1u_split_rshift( 
    ...
    _______, KC_CAPS, XXXXXXX, KC_PGDN, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME, KC_END, XXXXXXX, _______,        
    _______, XXXXXXX, KC_COPY, KC_CUT, XXXXXXX, XXXXXXX, LCTL(KC_LEFT), XXXXXXX, KC_APP, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, 
